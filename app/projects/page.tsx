            ...
            <Card>
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-zinc-400">
                    Ini adalah deskripsi singkat tentang isi card kelima.
                  </p>
                </div>
                <div className="flex items-center justify-between gap-2 mt-4">
                  <span className="text-zinc-500 text-xs flex items-center gap-1">
            ...
            <Card>
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-zinc-400">
                    Ini adalah deskripsi singkat tentang isi card keenam.
                  </p>
                </div>
                <div className="flex items-center justify-between gap-2 mt-4">
                  <span className="text-zinc-500 text-xs flex items-center gap-1">
            ...
            <Card>
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-zinc-400">
                    Ini adalah deskripsi singkat tentang isi card ketujuh.
                  </p>
                </div>
                <div className="flex items-center justify-between gap-2 mt-4">
                  <span className="text-zinc-500 text-xs flex items-center gap-1">
            ...
            <Card>
              <article className="relative w-full h-full p-4 md:p-8">
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-zinc-400">
                    Ini adalah deskripsi singkat tentang isi card kedelapan.
                  </p>
                </div>
                <div className="flex items-center justify-between gap-2 mt-4">
                  <span className="text-zinc-500 text-xs flex items-center gap-1">
